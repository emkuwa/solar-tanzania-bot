...
# 1. SETUP - Inasoma Gemini Key pekee
genai.configure(api_key=os.getenv("GEMINI_API_KEY"))
model = genai.GenerativeModel('gemini-1.5-flash')

# Tengeneza au safisha folder la dist
if os.path.exists('dist'):
    shutil.rmtree('dist')
os.makedirs('dist')

# 2. AI RESEARCH - Gemini inatafuta orodha ya makampuni
print("🔍 Gemini inatafuta makampuni halisi...")
prompt = "Orodhesha majina 8 ya makampuni halisi na makubwa ya solar yanayofanya kazi Tanzania na mikoa yalipo. Format: Jina | Mkoa"
...
try:
    ...
    # 3. Tengeneza Index.html (Ukurasa wa Mwanzo)
    index_html = f'''
    <!DOCTYPE html>
    <html lang="sw">
    <head>
    ...
    with open("dist/index.html", "w", encoding="utf-8") as f:
        f.write(index_html)
    print("✅ Website imetengenezwa vizuri!")
